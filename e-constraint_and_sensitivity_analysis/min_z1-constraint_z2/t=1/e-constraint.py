...
Solver.options['ranges'] = r"C:\Users\Emir\Desktop\case2\e-constraint\min_z1-constraint_z2\t=1\SA_Report_e-constraint.txt"
SolverResults = Solver.solve(model, tee=True)
model.eTotal_Cost.display()
model.vIdle.display()

pyo_SA.reorganize_SA_report(file_path_SA = r"C:\Users\Emir\Desktop\case2\e-constraint\min_z1-constraint_z2\t=1\SA_Report_e-constraint.txt",
                            file_path_LP_labels = r"C:\Users\Emir\Desktop\case2\e-constraint\min_z1-constraint_z2\t=1\model_labels_e-constraint.lp",
                                file_path_LP_nolabels = r"C:\Users\Emir\Desktop\case2\e-constraint\min_z1-constraint_z2\t=1\model_nolabels_e-constraint.lp")
